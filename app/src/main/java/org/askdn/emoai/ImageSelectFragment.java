 ...
 */
public class ImageSelectFragment extends Fragment implements View.OnClickListener, FragmentCompat.OnRequestPermissionsResultCallback {
    ...
    private static final String TAG = ImageSelectFragment.class.getName();
    /**
    ...
    private void setUpCameraOutputs(int height, int width) {
        ...
        try {
            for(String cameraID:cameraManager.getCameraIdList()) {
                ...
                Integer lens_facing = chars.get(CameraCharacteristics.LENS_FACING);

                // App is using a Front Facing Camera as default, Hence a back Camera is skipped
